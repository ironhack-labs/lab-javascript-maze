...
Maze.prototype.isPathRight   = function(){
  switch (this._miner.dir) {
    ...
    if(this._miner.row !==(this._maze[0].length-1)) return (this._maze[this._miner.row ][this._miner.col +1]);
    ...
    if(this._miner.row !==0) return (this._maze[this._miner.row ][this._miner.col -1]);
